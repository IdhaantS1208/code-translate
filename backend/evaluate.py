...
def get_evaluation_prompt(
    ...
    1. logic_preservation (score 1–10)
       Does the translated code perform the same operations and produce the same outcomes as the source?
          Penalise any missing logic, added assumptions, or behavioural drift.
             A score of 10 means the logic is perfectly preserved — every branch, loop, and computation is equivalent.

             2. idiomatic_quality (score 1–10)
                Does the translated code look like it was written natively in {target_lang}, or does it look like a mechanical line-by-line conversion?
                   Reward use of native patterns, conventions, idioms, and standard library features of {target_lang}.
                      A score of 10 means an experienced {target_lang} developer would not guess this was translated.

                      3. explainability (score 1–10)
                         How thoroughly and accurately does the thinking output explain the translation decisions?
                            It should cover: what changed directly, what had no direct equivalent and how it was handled, and how core logic was preserved.
                               If no thinking output was provided, the score MUST be 0.

                               === RESPONSE FORMAT ===

                               Respond with this exact JSON structure, filling in the score (integer 1–10) and a single concise sentence justification for each dimension:
